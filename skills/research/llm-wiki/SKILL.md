...
## Architecture: Three Layers + Learnings Feeder

The wiki has three core layers, plus a **learnings feeder** directory outside the wiki
that feeds new findings into the knowledge base:
...
**Learnings Feeder** (lives at `~/brain/agent/learnings/`, outside the wiki dir):
- Auto-archived delegate_task findings via `scripts/archive_learning.py`
- YAML frontmatter + markdown, same format as wiki pages
- Chronological, append-only, never overwritten
- New knowledge appears here first, matures into wiki entities/concepts
- Template: `templates/learning-template.md`
- Detailed pattern: `references/learnings-archival-pattern.md`
